...
class CoreDataSystem {
  ...
  private func findCorrectDataStack(stack: CoreDataEntity) -> [NSManagedObject]{
    ...
    func saveTaskToCoreData(name: String, detail: String,reward: Int,color: String,difficulty: String,skillName: String?,skillIndex: Int,isSkillSelected: Bool,balancerValue: Int) {
      ...
      let task = NSManagedObject(entity: entity, insertInto: managedContext)
        ...
        task.setValue(balancerValue, forKey: "balancerValue")
